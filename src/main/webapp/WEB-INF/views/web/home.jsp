...
<%--            <!-- Slide 1 -->--%>
<%--            <div style="background: url('<c:url value="/template/web/images/slider/slide-1.jpg"/>') no-repeat;--%>
...
<%--            <!-- Slide 2 -->--%>
<%--            <div style="background: url('<c:url value="/template/web/images/slider/slider-2.jpg"/>') no-repeat;--%>
<%--                    background-size: cover;--%>
<%--                    border-radius: 0.5rem;--%>
<%--                    background-position: center">--%>
<%--                <div class="ps-lg-12 py-lg-16 col-xxl-5 col-md-7 py-14 px-8 text-xs-center">--%>
