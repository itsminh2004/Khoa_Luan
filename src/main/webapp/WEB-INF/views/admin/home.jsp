                    ...
                    <div class="col-lg-12 col-12">
                        <div class="stat-card">
                            ...
                            <div class="stat-content" style="width: 100%">
                                <p>Sản phẩm bán chạy nhất tháng ${currentMonth}</p>
                                <div class="d-flex justify-content-between align-items-center">
                                    <h3>${topProduct}</h3>
                                    <span class="badge badge-primary p-2" style="font-size: 1rem;">Đã bán:
                                        ${topProductSold}</span>
                                </div>

                                <c:if test="${not empty top5Products}">
                                    <hr>
                                    <p class="mb-2"><strong>Top 5 sản phẩm của tháng:</strong></p>
                                    <div class="table-responsive">
                                        <table class="table table-sm table-hover">
                                            ...
                                            <tbody>
                                                <c:forEach var="item" items="${top5Products}">
                                                    <tr>
                                                        <td>${item.Name}</td>
