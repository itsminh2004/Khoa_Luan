    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-body p-5">
                <form:form method="post" action="${pageContext.request.contextPath}/admin-brand-add"
                           modelAttribute="brand" enctype="multipart/form-data" id="brandForm">

                    <div class="form-group">
                        <label><i class="fas fa-tag text-primary mr-2"></i> Tên thương hiệu <span class="text-danger">*</span></label>
                        <form:input path="name" cssClass="form-control" placeholder="Nhập tên thương hiệu (VD: Apple, Samsung...)" id="name" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="custom-file">
                            ...
                            <label class="custom-file-label" for="fileAnh">Chọn file ảnh...</label>
                        </div>
                    ...
                    <div class="form-group">
                        <div class="custom-control custom-switch">
                            <form:checkbox path="active" cssClass="custom-control-input" id="active" checked="checked" />
