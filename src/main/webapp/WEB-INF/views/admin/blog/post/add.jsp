...
<section class="content">
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                <form action="${pageContext.request.contextPath}/admin-blog-post/add" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <small class="form-text text-muted">Chọn ảnh từ máy để upload làm thumbnail.</small>
                    ...
                    <div class="form-actions mt-3">
                        ...
                        <a href="<c:url value='/admin-blog-post'/>" class="btn btn-secondary">Hủy</a>
                    </div>
                </form>
            </div>
        </div>
