...
var FullCalendar = (function (exports) {
    ...
    ***************************************************************************** */
    ...
    // and want to see originating element (the 'target'), use this laptrinhjavaweb.util instead
    ...
    */
    ...
    // TODO: new laptrinhjavaweb.util arrayify?
    ...
    */
    ...
    eventConfig, mutation, context) {
        ...
        // better laptrinhjavaweb.util for this?
        if (eventDef.allDay) {
            copy.range = {
        ...
        CalendarApi.prototype.addEvent = function (eventInput, sourceInput) {
            if (eventInput instanceof EventApi) {
                ...
                if (!currentData.eventStore.defs[def.defId]) {
                    this.dispatch({
                        type: 'ADD_EVENTS',
                        eventStore: eventTupleToStore({ def: def, instance: instance }), // TODO: better laptrinhjavaweb.util for two args?
                    });
    ...
    var DateEnv = /** @class */ (function () {
        ...
        might as well use buildIsoString or some other laptrinhjavaweb.util directly
        */
    ...
    */
    ...
    // QUESTION: why not just return instances? do a general object-property-exclusion laptrinhjavaweb.util
    ...
    */
    ...
    function injectDomNodes(el, domNodes) {
        var oldNodes = Array.prototype.slice.call(el.childNodes); // TODO: use array laptrinhjavaweb.util
        var newNodes = Array.prototype.slice.call(domNodes); // TODO: use array laptrinhjavaweb.util
    ...
    */
    ...
    // TODO: move to general laptrinhjavaweb.util
    ...
    */
    ...
    // TODO: move to a general laptrinhjavaweb.util file?
